...
function SearchBar() {
  return (
    <div className="bg-search-input-container-background flex p-3 items-center gap-3 h-16">
        ...
        <div className="px-3">
            <BsFilter className="text-panel-header-icon cursor-pointer text-2xl" title="Filter"/>
        </div>
    </div>
  )
}
